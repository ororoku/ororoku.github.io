...
* Redoの使い方 他のコマンドを使用すると，変更取り消しコマンドの連続を中断．中断するとそれまでの変更取り消しコマンド自身が取り消し可能な普通のコマンドとみなされる．
このようにしてC-f(一文字進む)などのそれほど重要な効果のないコマンドを入力して，取り消された変更を再生出来る．そのあとはさらに変更取り消しコマンドを使用可能
