...
本節の記述については[こちらの記事](https://yonehub.y10e.com/2019/12/24/20191223_git_gitignore/)を参考にさせていただいた。
...
## References
* [WindowsにGitをインストールする手順(2021年12月更新)](https://www.curict.com/item/60/60bfe0e.html)
  * ターミナルの設定は"Use Windows' default console window"を選んだ。それ以外はこのブログに従った
